...
<div class="mb-3">
  ...
  <input type="text" name="genero" id="genero" value="{{$libro->genero}}" class="form-control"  >
</div>
...
<div class="mb-3">
  ...
  <input type="text" name="editorial" id="editorial" value="{{$libro->editorial}}" class="form-control"  >
</div>

<div class="mb-3">
  <label for="exampleFormControlInput1" class="form-label">{{'isbm'}}</label>
  <input type="text" name="isbm" id="isbm" value="{{$libro->isbm}}" class="form-control"  >
</div>



<input  class="btn btn-success" type="submit" value="editar" onclick="return confirm('¿editar?')">
